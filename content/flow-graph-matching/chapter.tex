...
\subsubsection{A more abstract problem as Project Selection Problem}
...
\subsection{Maximum Weight Independent Set in a Bipartite graph}
...
$-$ Edge $(S - left)$ $(cap = weight_{left})$
$-$ Edge $(right - T)$ $(cap = weight{right})$
$-$ For every edge $(left - right)$ build edge $left - right$ $(cap = +\inf)$
$-$ Min-cut $=$ MWVC, then MWIS $=$ total_weight $-$ MWVC.

\subsection{Maximum flow with flow in range [L, R]}
Solution:
...
$-$ Add an edge from $T$ to $S$ with $cap = +\inf$
